...
// const contactItems = [
//   { href: "mailto:hello@griffinsweb.com", label: "hello@griffinsweb.com", icon: <Mail /> },
//   { href: "tel:+1234567890", label: "(123) 456-7890", icon: <Phone /> },
//   { href: "https://www.google.com/maps", label: "123 Main St, Anytown, USA", icon: <MapPin /> },
// ];
...
export default function Footer() {
  return (
    <footer className="bg-bg text-headingpy-4 w-9/10 mx-auto lg:w-auto">
